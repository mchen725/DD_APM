...
def ResNet6BN(channel, num_classes):
    return ResNet_simple(BasicBlock, [1,1], channel=channel, num_classes=num_classes, norm='batchnorm')

def ResNet6(channel, num_classes):
    return ResNet_simple(BasicBlock, [1,1], channel=channel, num_classes=num_classes)

# def ResNet18BN(channel, num_classes):
#     return ResNet(BasicBlock, [2,2,2,2], channel=channel, num_classes=num_classes, norm='batchnorm')
def ResNet18BN(channel, num_classes):
    return ResNet_large(BasicBlock, [2,2,2,2], channel=channel, num_classes=num_classes, norm='batchnorm')
